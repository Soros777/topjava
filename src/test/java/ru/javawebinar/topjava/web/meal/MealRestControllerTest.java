...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getBetween() throws Exception {
        String from = "2020-01-31T00:00:00";
        String to = "2020-01-31T23:59:00";
        String request = REST_URL + "filter?startDateTime=" + from + "&endDateTime=" + to;
        perform((MockMvcRequestBuilders.get(request)))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MEAL_TO_MATCHER.contentJson(MealsUtil.getTos(List.of(meal7, meal6, meal5, meal4),SecurityUtil.authUserCaloriesPerDay())));
    }
}